...
class KunalKaushal:
    def __init__(self):
        ...
        self.education  = "B.Tech AI/ML, GL Bajaj Institute of Technology (2023–2027)"
...
![FAISS](https://img.shields.io/badge/FAISS-009688?style=flat-square&logo=meta&logoColor=white)
![SentenceTransformers](https://img.shields.io/badge/SentenceTransformers-FFD43B?style=flat-square&logo=huggingface&logoColor=black)
...
### 🛡️ [Sentinel SOC Dashboard](https://github.com/Kunal-Kaushal/Sentinel-SOC)
> RAG-based threat analysis system processing **10,000+ security logs per session**
...
### 📚 [Archon — Local RAG Pipeline](https://github.com/Kunal-Kaushal/Archon)
> Production-ready RAG over **500+ documents** with a single command — no Docker, no cloud
...
`Python` `Google ADK` `Gemini 2.0 Flash` `Firestore` `SendGrid`
- Specialized agents orchestrated via Google ADK with structured outputs for sequential execution
- Automated email workflows via SendGrid — **~80% reduction in manual HR processing time**
...
![Kunal's GitHub stats](https://github-readme-stats.vercel.app/api?username=Kunal-Kaushal&show_icons=true&theme=tokyonight&hide_border=true&count_private=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Kunal-Kaushal&layout=compact&theme=tokyonight&hide_border=true)

![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=Kunal-Kaushal&theme=tokyonight&hide_border=true)
